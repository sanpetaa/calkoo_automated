...
*	In case of any change on the webpage
And if  multipliers will not be equivalent to the VAT rates. 
Then the calcultion would be wrong.

##### testcase.CheckCalculations.java 

*	Cheking the whole calculation process and compare it to my local calculation. I selected the 3 most commen countries at global blue TOP destinations: https://www.globalblue.com/corporate/media/press/global-blue-research-confirms-the-chinese-are-still-the-most-valuable-globe-shoppers. Check on all available VAT rates even If  I am filling the Netprice, VatSum or Price fields and Chekcing the pie chart if it correct or not. 
